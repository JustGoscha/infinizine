...
const ICON_PATHS: Record<string, string> = {
  // outline pen-nib at 45° (tip bottom-left, hole + slit)
  pen: '<path d="M13.4 4.6 L16.6 1.4 A1.2 1.2 0 0 1 18.3 1.4 L22.6 5.7 A1.2 1.2 0 0 1 22.6 7.4 L19.4 10.6"/><path d="M13.4 4.6 L6.7 7.9 L2.4 20.3 A1 1 0 0 0 3.7 21.6 L16.1 17.3 L19.4 10.6"/><circle cx="11" cy="13" r="1.7"/><path d="M9.7 14.3 L3 21"/>',
  // outline pencil (Lucide)
  pencil: '<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/>',
  // fineliner: slim pen body with a fine filled tip
  fineliner: '<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="M2.3 21.7 L3.6 17.7 L6.3 20.4 Z" fill="currentColor" stroke="none"/>',
